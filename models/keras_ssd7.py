...
def build_model(image_size,
    ...
    conv1_2 = Conv2D(32, (5, 5), strides=(1, 1), padding="same", kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='conv1')(conv1_1)
    conv1 = BatchNormalization(axis=3, momentum=0.99, name='bn1')(conv1_2) # Tensorflow uses filter format [filter_height, filter_width, in_channels, out_channels], hence axis = 3
    ...
    conv2_2 = Conv2D(48, (3, 3), strides=(1, 1), padding="same", kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='conv2')(conv2_1)
    conv2 = BatchNormalization(axis=3, momentum=0.99, name='bn2')(conv2_2)
    ...
    conv3_2 = Conv2D(64, (3, 3), strides=(1, 1), padding="same", kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='conv3')(conv3_1)
    conv3 = BatchNormalization(axis=3, momentum=0.99, name='bn3')(conv3_2)
    ...
    conv4_2 = Conv2D(64, (3, 3), strides=(1, 1), padding="same", kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='conv4')(conv4_1)
    conv4 = BatchNormalization(axis=3, momentum=0.99, name='bn4')(conv4_2)
    ...
    conv5_2 = Conv2D(48, (3, 3), strides=(1, 1), padding="same", kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='conv5')(conv5_1)
    conv5 = BatchNormalization(axis=3, momentum=0.99, name='bn5')(conv5_2)
    ...
    conv6_2 = Conv2D(48, (3, 3), strides=(1, 1), padding="same", kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='conv6')(conv6_1)
    conv6 = BatchNormalization(axis=3, momentum=0.99, name='bn6')(conv6_2)
    ...
    conv7_2 = Conv2D(32, (3, 3), strides=(1, 1), padding="same", kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='conv7')(conv7_1)
    conv7 = BatchNormalization(axis=3, momentum=0.99, name='bn7')(conv7_2)
